...
float x, y, z; // gyroscope readings
...
void loop()
{
  ...
  // Encoder setup
  slave.buffer.leftEncoder = pulseIn(lPin, HIGH);
  slave.buffer.rightEncoder = pulseIn(rPin, HIGH);

  // Gyroscope setup
  // if (IMU.gyroscopeAvailable()) {
  //   IMU.readGyroscope(x, y, z);

  //   slave.buffer.xGyro = x;
  //   slave.buffer.yGyro = y;
  //   slave.buffer.zGyro = z;
  // }
  float data = IMU.readGyroscope(x, y, z);
  slave.buffer.xGyro = x;
  slave.buffer.yGyro = y;
  slave.buffer.zGyro = z;
